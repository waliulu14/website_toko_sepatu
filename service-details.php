        ...
        <section class="servicedetails" class="section-p1">
            ...
            <div class="signle-pro-details">
                ...
                if (isset($_SESSION['user_id'])) {
                    ...
                    ?>
                   <p id="loginText">Silakan <a href="login.php" id="loginLink"><i class="fas fa-sign-in-alt"></i></a> untuk memesan layanan ini.</p>
<p id="registerText">Jika belum memiliki akun, silakan <a href="register.php" id="registerLink"><i class="fas fa-user-plus"></i></a> terlebih dahulu.</p>
